...
<?php if ($this->item->params->get('show_title')) : ?>
		...
		<div class="title_wrapper"><h2><span><a href="<?php echo $this->item->readmore_link; ?>">
...
<div class="articlefooter">
	...
	<div class="auth_info<?php echo $this->params->get('pageclass_sfx')?>">
		<?php if (($this->item->params->get('show_author')) && ($this->item->author != "")) : ?>
			<span class="small"><?php JText::printf( 'Written by', ($this->escape($this->item->created_by_alias) ? $this->escape($this->item->created_by_alias) : $this->escape($this->item->author)) ); ?></span>
		<?php endif; ?>
