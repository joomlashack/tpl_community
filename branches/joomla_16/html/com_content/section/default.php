...
<h2 class="componentheading<?php echo $this->params->get('pageclass_sfx');?>"><?php echo jShackFunc::titleStyle($this->escape($this->params->get('page_title')), $titleSeparator); ?></h2>
<?php endif; ?>
