...
<!--			<br /> -->
			<label id="contact_textmsg" for="contact_text" style="vertical-align: top;">
				&nbsp;<?php echo JText::_( 'Enter your message' );?>:
			</label>
<!--			<br /> -->
			<div class="nopad"><textarea cols="50" rows="10" name="text" id="contact_text" class="inputbox required"></textarea></div>
			<?php if ($this->contact->params->get( 'show_email_copy' )) : ?>
<!--			<br /> -->
				<div class="nopad"><input type="checkbox" name="email_copy" id="contact_email_copy" value="1"  />
