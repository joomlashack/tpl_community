...
<?php if ($canEdit || $this->params->get('show_title') || $this->params->get('show_pdf_icon') || $this->params->get('show_print_icon') || $this->params->get('show_email_icon')) : ?>
	...
	<?php if ($this->params->get('show_title')) : ?>
		...
		<div class="title_wrapper"><h2><span><a href="<?php echo $this->article->readmore_link; ?>"><?php echo jShackFunc::titleStyle($this->escape($this->article->title), $titleSeparator); ?></a></span></h2></div>
		<?php else : ?>
			<div class="title_wrapper"><h2><span><?php echo jShackFunc::titleStyle($this->escape($this->article->title), $titleSeparator); ?></span></h2></div>
		<?php endif; ?>
	<?php endif; ?>
...
<div class="articlefooter<?php echo $this->params->get('pageclass_sfx')?>">
	<?php if (($this->params->get('show_author')) && ($this->article->author != "") || $this->params->get('show_create_date')) : ?>
